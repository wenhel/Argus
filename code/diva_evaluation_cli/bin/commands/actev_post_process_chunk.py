"""Actev module: post-process-chunk
...
class ActevPostProcessChunk(ActevCommand):
    ...
    """
    def __init__(self):
        super(ActevPostProcessChunk, self).__init__('post-process-chunk', entry_point)
    ...
    def cli_parser(self, arg_parser):
        ...
        """
        arg_parser.description = "Post-process a chunk"
        ...
        arg_parser.set_defaults(func=ActevPostProcessChunk.command, object=self)
